        ...
        <section id="pricing" className="py-16 bg-linear-to-r from-brand-2/30 to-brand-3/20">
            <div className="max-w-6xl mx-auto px-6 text-center">
                ...
                <div className="flex justify-center gap-4">
                    <Link to="/signup" className="px-6 py-3 rounded-xl bg-brand-4 text-brand-1 font-semibold">Start Free</Link>
                    <a  className="px-6 py-3 rounded-xl border border-white/20 text-white cursor-pointer">Contact Sales</a>
                </div>
            </div>
        </section>
    )
